    ...
    with tab_info:
        ...
        with c2:
            st.markdown("""<div class='contact-card'>
                ...
                <div class='contact-desc'>Механічні пошкодження майна, ремонт корпусів, заміна пропелерів.</div>
                <b>Сергій</b><br>+380997517054
                </div>""", unsafe_allow_html=True)
        with c3:
            st.markdown("""<div class='contact-card'>
                <div class='contact-title'>📦 Начальник складу</div>
                <div class='contact-desc'>Облік майна, переміщення та передача обладнання між підрозділами.</div>
